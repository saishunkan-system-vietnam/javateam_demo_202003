<template>
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div
      class="p-3 sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"
      @mouseover="mouseOver"
    >
        ...
        <div class="os-viewport os-viewport-native-scrollbars-invisible">
          <div class="os-content">
            ...
            <div class="mb-1">
              ...
              <span>No Navbar border</span>
            </div>
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
              <span>Body small text</span>
            </div>
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
            ...
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
              <span>Sidebar nav small text</span>
            </div>
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
              <span>Footer small text</span>
            </div>
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
            ...
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
              <span>Sidebar nav compact</span>
            </div>
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
              <span>Sidebar nav child indent</span>
            </div>
            <div class="mb-1">
              <input type="checkbox" value="1" class="mr-1" />
              <span>
                Main Sidebar disable hover/focus
                auto expand
              </span>
            </div>
            <div class="mb-4">
      ...
      <div
        ...
        :class="isMouseOver && 'os-scrollbar-auto-hidden'"
      >
