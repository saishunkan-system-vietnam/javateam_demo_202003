  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="card card-primary " :class="[isActiveMenu ? '':'collapsed-card']">
              <div class="card-header">
                <h3 class="card-title">Expandable</h3>

                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse" @click="openMenu">
                    <i class="" :class="[isActiveMenu ? 'fas fa-minus':'fas fa-plus']"></i>
                  </button>
                </div>
                <!-- /.card-tools -->
              </div>
          ...
          <!-- /.col -->
          <div class="col-md-3">
            <div class="card card-success" :class="[isActiveMenu1 ? 'collapsed-card':'']">
              <div class="card-header">
                <h3 class="card-title">Collapsable</h3>

                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse" @click.prevent="openMenu1">
          ...
          <!-- /.col -->
          <div class="col-md-3">
            <div class="card card-warning" :style="isRemove ? 'display: none;': ''">
              <div class="card-header">
          ...
          <!-- /.col -->
          <div class="col-md-3">
            <div class="card card-danger" :class="isZoom ? 'maximized-card':''">
              <div class="card-header">
                <h3 class="card-title">Maximizable</h3>

                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="maximize" @click="zoom">
                    <i class="" :class="isZoom ? 'fas fa-compress':'fas fa-expand'"></i>
                  </button>
                </div>
                <!-- /.card-tools -->
              </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="card card-primary" :class="isTest ? '':''">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button
                    ...
                    data-source="views/widget/widget.vue"
                    data-source-selector="#card-refresh-content" @click="test"
                  >
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-widget">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <img class="img-fluid pad" src="../../assets/img/photo2.png" alt="Photo" />
